        ...
        <li>
            ...
            <div className='grid grid-cols-5 gap-[10px]'>
                <div className='col-span-1 border-1 border-stone-200 overflow-hidden rounded-[8px] bg-white relative group'>
                    ...
                    <a href=""><div className='w-[35px] h-[35px] bg-[#f03248] rounded-[50%] flex items-center justify-center absolute right-[10px] top-[20px] opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:translate-y-[-10px] transition duration-400'><GoHeart fontSize={20} color='white'/></div></a>
                    </div>
